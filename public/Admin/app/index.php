...
<html lang="en">
  ...
  <body>
    ...
    <div class="sh-logopanel">
      <a href="" class="sh-logo-text">UTTehuacan</a>
    ...
    <div class="sh-sideleft-menu">
      <label class="sh-sidebar-label">Navegacion</label>
      <ul class="nav">
        <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <ul class="nav-sub">
            <li class="nav-item"><a href="form-elements.html" class="nav-link">Estadisticas</a></li>
            <li class="nav-item"><a href="form-layouts.html" class="nav-link">Agregar afiliados</a></li>
          </ul>
      </ul>
